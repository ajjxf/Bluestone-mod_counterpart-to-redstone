 ...
 * Blocks tabs.
 *
 * <p>The custom tab is built with vanilla {@link CreativeModeTab#builder()} (Forge 1.20.1 lets
...
public final class ModItemGroups {
    ...
    public static final RegistryObject<CreativeModeTab> BLUESTONE = CREATIVE_MODE_TABS.register("bluestone",
